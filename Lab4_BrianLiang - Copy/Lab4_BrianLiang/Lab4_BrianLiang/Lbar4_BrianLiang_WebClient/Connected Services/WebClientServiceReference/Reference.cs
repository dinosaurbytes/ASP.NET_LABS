...
namespace Lbar4_BrianLiang_WebClient.WebClientServiceReference {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="WebClientServiceReference.IIncidentService")]
    public interface IIncidentService {
        ...
        Lbar4_BrianLiang_WebClient.WebClientServiceReference.Incident[] GetAllIncidents(int techID);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IIncidentService/GetAllIncidents", ReplyAction="http://tempuri.org/IIncidentService/GetAllIncidentsResponse")]
        System.Threading.Tasks.Task<Lbar4_BrianLiang_WebClient.WebClientServiceReference.Incident[]> GetAllIncidentsAsync(int techID);
        ...
        Lbar4_BrianLiang_WebClient.WebClientServiceReference.Incident[] GetAllCustIncidents(int custID);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IIncidentService/GetAllCustIncidents", ReplyAction="http://tempuri.org/IIncidentService/GetAllCustIncidentsResponse")]
        System.Threading.Tasks.Task<Lbar4_BrianLiang_WebClient.WebClientServiceReference.Incident[]> GetAllCustIncidentsAsync(int custID);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IIncidentServiceChannel : Lbar4_BrianLiang_WebClient.WebClientServiceReference.IIncidentService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class IncidentServiceClient : System.ServiceModel.ClientBase<Lbar4_BrianLiang_WebClient.WebClientServiceReference.IIncidentService>, Lbar4_BrianLiang_WebClient.WebClientServiceReference.IIncidentService {
        ...
        public Lbar4_BrianLiang_WebClient.WebClientServiceReference.Incident[] GetAllIncidents(int techID) {
            return base.Channel.GetAllIncidents(techID);
        }
        
        public System.Threading.Tasks.Task<Lbar4_BrianLiang_WebClient.WebClientServiceReference.Incident[]> GetAllIncidentsAsync(int techID) {
            return base.Channel.GetAllIncidentsAsync(techID);
        }
        
        public Lbar4_BrianLiang_WebClient.WebClientServiceReference.Incident[] GetAllCustIncidents(int custID) {
            return base.Channel.GetAllCustIncidents(custID);
        }
        
        public System.Threading.Tasks.Task<Lbar4_BrianLiang_WebClient.WebClientServiceReference.Incident[]> GetAllCustIncidentsAsync(int custID) {
